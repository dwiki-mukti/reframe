...
import { isArray, isObject } from '@/Utls'
...
class FastifyReframer {
    ...
    /**
     * !!! Task: Mengubah type return dari interface FastifyRegister
     */
    public register: FastifyRegister = (plugin, opts) => {
        this.server.register(plugin, opts)
        return this
    }


    protected factory(controllers: (new () => any)[]) {
        /**
